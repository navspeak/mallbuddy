...
Ensure that your java environment is set properly before running this app. The project uses few Java 8 features, so you will need Java 8 to run and compile
The folder contains:
1. inventory.csv = contains list of items available in the inventory as comma separated values
...
- The **MallBuddy** is a maven project
 ...
 - The project uses few Java 8 features, so you will need Java 8 to run and compile
